...
const conditions = [
  ...
  },
  {
    ...
    description:
      "PTSD develops after experiencing or witnessing traumatic events. Our trauma-informed approach creates a safe space for processing and healing traumatic memories.",
  ...
  },
  {
    title: "Depression",
    description:
      "Depression affects mood, thinking, and daily functioning. Our holistic approach addresses the biological, psychological, and social factors contributing to depression.",
  ...
  },
  {
    ...
    description:
      "Addiction involves compulsive substance use despite harmful consequences. Our compassionate approach focuses on understanding the underlying factors driving addictive behaviors.",
...
export default function ConditionsSection() {
  ...
  return (
    <section
      className="conditions-section w-full py-16 md:py-20 relative bg-background overflow-hidden"
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-12">
            ...
            >
              Our integrative approach combines evidence-based therapies with
              holistic practices to address both symptoms and underlying causes.
              ...
              >
                ...
                <div className="bg-white dark:bg-black/40 backdrop-blur-sm p-6 rounded-xl border border-gray-300 dark:border-border/30 shadow-sm transition-all duration-300 relative overflow-hidden h-full flex flex-col cursor-pointer">
                  ...
                  <div className="space-y-2">
                    <p className="text-xs text-foreground/70 dark:text-foreground/50 font-medium uppercase tracking-wide">
                      Helpful Resources:
                    </p>
          ...
          >
            <div className="mb-4 md:mb-0 md:mr-6">
              <h3 className="text-lg font-semibold mb-1 text-foreground">
                Contact us about treatment options
              </h3>
