...
export default function AutoScrollPosts() {
  ...
  if (isLoading) {
    return (
      <section
        data-section="blog"
        className="w-full py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-b from-background to-background/95 overflow-hidden"
      >
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="flex flex-col items-start">
              ...
              <p className="text-sm sm:text-base text-foreground/70 max-w-xl">
                Explore our latest articles on mental health, therapeutic
                approaches, and personal growth strategies.
              </p>
            </div>
            <Link
              href="/blog"
              className="hidden md:flex items-center text-primary text-sm font-medium mt-4 md:mt-0 hover:translate-x-1 transition-transform duration-300 group"
            >
              View all articles
              <svg
                    ...
                    <div className="p-5 sm:p-6 md:p-8 lg:p-10 lg:w-3/5 xl:w-2/3 flex flex-col">
                      ...
                      <p className="text-muted-foreground text-sm sm:text-base mb-4 sm:mb-5 md:mb-6">
                        {featuredPost.excerpt ||
                          ...
                          "Read this article to learn more about holistic healing approaches."}
                      </p>
                    ...
                    <div className="lg:w-2/5 xl:w-1/3 relative">
                      <div className="relative h-[200px] sm:h-[240px] md:h-[280px] lg:h-full overflow-hidden">
                        ...
                        <motion.div
                          ...
                          onMouseEnter={() => {
                            if (featuredPost && featuredPost.id != null) {
                              setHoveredPostId(Number(featuredPost.id));
                            }
                          }}
                        ...
                        >
                          <Image
                            src={
                              ...
                              "https://images.unsplash.com/photo-1559595500-e15296bdbb48?q=80&w=800&auto=format&fit=crop"
                            }
