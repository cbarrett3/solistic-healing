...
export default function ContactSection() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    if (errors[name as keyof ContactFormData]) {
      setErrors((prev: Partial<Record<keyof ContactFormData, string>>) => ({ ...prev, [name]: undefined }));
    }
  };
  ...
  return (
    <section id="contact" data-section className="w-full py-16 md:py-24 bg-background relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-foreground/90 mt-4 max-w-2xl mx-auto font-medium">
            Take the first step toward mental wellness. Contact us to schedule a free 15-minute consultation
            and learn how our services can help you achieve lasting positive change.
          </p>
        </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 bg-white dark:bg-white/5 border ${errors.name ? 'border-red-500' : 'border-gray-300 dark:border-white/10'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all duration-300`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-2.5 bg-white dark:bg-white/5 border ${errors.email ? 'border-red-500' : 'border-gray-300 dark:border-white/10'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all duration-300`}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-2.5 bg-white dark:bg-white/5 border ${errors.subject ? 'border-red-500' : 'border-gray-300 dark:border-white/10'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all duration-300`}
                ...
                {errors.subject && (
                  <p className="mt-1.5 text-xs text-red-500 font-medium">{errors.subject}</p>
                )}
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2.5 bg-white dark:bg-white/5 border ${errors.message ? 'border-red-500' : 'border-gray-300 dark:border-white/10'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all duration-300`}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-white/5 backdrop-blur-sm border border-gray-300 dark:border-white/10 rounded-xl p-5 flex items-start hover:bg-gray-50 dark:hover:bg-white/10 hover:border-primary/30 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-foreground/80 dark:text-foreground/70 text-sm truncate">+1 612-412-4873</p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-white/5 backdrop-blur-sm border border-gray-300 dark:border-white/10 rounded-xl p-5 flex items-start hover:bg-gray-50 dark:hover:bg-white/10 hover:border-primary/30 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-foreground/80 dark:text-foreground/70 text-sm truncate">ericpeterson@solistichealing.org</p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-white/5 backdrop-blur-sm border border-gray-300 dark:border-white/10 rounded-xl p-5 flex items-start hover:bg-gray-50 dark:hover:bg-white/10 hover:border-primary/30 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="min-w-0">
                  <h4 className="text-sm font-semibold text-foreground mb-1">Hours</h4>
                  <p className="text-foreground/80 dark:text-foreground/70 text-sm">Mon-Fri: 9am - 7pm</p>
                  <p className="text-foreground/80 dark:text-foreground/70 text-sm">Sat: 10am - 4pm</p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-white/5 backdrop-blur-sm border border-gray-300 dark:border-white/10 rounded-xl p-5 flex items-start hover:bg-gray-50 dark:hover:bg-white/10 hover:border-primary/30 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-foreground/80 dark:text-foreground/70 text-sm truncate">1611 County Road B West, Suite 214</p>
                  <p className="text-foreground/80 dark:text-foreground/70 text-sm truncate">Roseville, MN, 55113</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-white/5 backdrop-blur-sm border border-gray-300 dark:border-white/10 rounded-xl overflow-hidden shadow-sm">
              ...
              <div className="p-4 bg-gray-100 dark:bg-black/30 backdrop-blur-sm border-t border-gray-300 dark:border-white/10">
                <div className="flex items-center">
                  ...
                  <p className="text-sm font-medium text-foreground/90 dark:text-foreground/80">Solistic Healing - Suite 214</p>
                </div>
              </div>
            </div>
          </motion.div>
