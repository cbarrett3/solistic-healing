        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5 flex items-start hover:bg-white/10 hover:border-primary/30 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-foreground/70 text-sm truncate">+1 612-412-4873</p>
                </div>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5 flex items-start hover:bg-white/10 hover:border-primary/30 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-foreground/70 text-sm truncate">ericpeterson@solistichealing.org</p>
                </div>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5 flex items-start hover:bg-white/10 hover:border-primary/30 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="min-w-0">
                  <h4 className="text-sm font-medium text-foreground mb-1">Hours</h4>
                  <p className="text-foreground/70 text-sm">Mon-Fri: 9am - 7pm</p>
                  <p className="text-foreground/70 text-sm">Sat: 10am - 4pm</p>
                </div>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-5 flex items-start hover:bg-white/10 hover:border-primary/30 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="min-w-0">
                  <h4 className="text-sm font-medium text-foreground mb-1">Address</h4>
                  <p className="text-foreground/70 text-sm truncate">1611 County Road B West, Suite 214</p>
                  <p className="text-foreground/70 text-sm truncate">Roseville, MN, 55113</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden">
              ...
              <div className="p-4 bg-black/30 backdrop-blur-sm">
                <div className="flex items-center">
                  ...
                  <p className="text-sm text-foreground/80">Solistic Healing - Suite 214</p>
                </div>
              </div>
            </div>
          </motion.div>
