    ...
    <section id="media" className="w-full py-16 md:py-24 bg-gradient-to-b from-background to-background/80" data-section="media">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {/* Main Video Player */}
          <div 
            className="lg:col-span-2 relative rounded-xl overflow-hidden aspect-video bg-black shadow-xl"
            ref={containerRef}
          ...
          <div className="lg:col-span-1">
            <div className="space-y-4 h-full flex flex-col">
              <h3 className="text-xl font-medium text-foreground">More Videos</h3>
