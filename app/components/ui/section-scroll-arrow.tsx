    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white/10 dark:bg-black/20 backdrop-blur-sm flex items-center justify-center border border-primary/30 dark:border-white/10 shadow-lg group-hover:bg-primary/20 group-hover:border-primary/30 transition-all duration-300">
            <svg 
